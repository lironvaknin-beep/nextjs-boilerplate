...
import styles from './builder.module.css'; // <-- שינוי 1: ייבוא נכון של ה-CSS
...
  return (
    // <-- שינוי 2: הסרת הרכיב <Head>
    <>
      {/* שינוי 3: כל שמות הקלאסים עודכנו להשתמש ב-styles מה-CSS Module */}
...
            <p className={styles.starterSubtitle}>{t.subtitle}</p>
...
            <div className={styles.formGroup}>
              <label className={styles.formLabel} htmlFor="prompt-textarea">{t.promptLabel}</label>
              <textarea
                id="prompt-textarea"
