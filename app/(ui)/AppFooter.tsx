...
// Based on UX research, the primary action "Create" is centered and emphasized.
// Navigation is simplified to core user journeys.
const NAV_LINKS = [
    { href: '/', label: 'Home', icon: <HomeIcon /> },
    { href: '/explore', label: 'Explore', icon: <ExploreIcon /> },
    { href: '/builder', label: 'Create', icon: <CreateIcon />, primary: true }, // Primary action
...
export default function AppFooter() {
    ...
    return (
        <footer className="appFooter">
            {NAV_LINKS.map(({ href, label, icon, primary = false }) => {
